...
import org.sonarsource.plugins.example.rules.CreateIssuesOnCsFilesSensor;
...
import org.sonarsource.plugins.example.rules.CsRulesDefinition;
...
//      .addExtensions(ExampleMetrics.class, SetSizeOnFilesSensor.class, ComputeSizeAverage.class, ComputeSizeRating.class);
    ...
    // tutorial on rules
    context.addExtensions(CsRulesDefinition.class, CreateIssuesOnCsFilesSensor.class);
